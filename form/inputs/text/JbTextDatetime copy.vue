    ...
    methods: {
        ...
        definirTipo(tipo){
            if(tipo){
                ...
                if(this.$jb.regex.date_us.test(v)){
                    this.picker.tipo = 'date'
                }
                else if (this.$jb.regex.datetime_us.test(v)){
                    this.picker.tipo = 'datetime'
                }
                else if(this.$jb.regex.time.test(v)){
        ...
        textFieldEmitInput(v){
            if(this.$jb.regex.date_us.test(v) || this.$jb.regex.datetime_us.test(v)){
                this.$emit('input', v)
            }
            this.fechar()
        },
